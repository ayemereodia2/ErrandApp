...
//                   })
//                   dispatch(errandDetails({ errandId: data?.id }))
//                   dispatch(externalUserDetails({ user_id: data?.user_id }))
//                 }}
...
//                           {' '}
//                           {getCardTimeAgo(data?.updated_at)}
//                         </Text>
//                       </View>
//                     </View>
//                   </View>
...
//                   </Text>
//                   {/* {data.dropoff_address?.address_text ? (
//                     data.dropoff_address?.address_text
//                   ) : (
...
//                     >
//                       {' '}
//                       {data?.total_bids === 0 ? '' : data?.total_bids}{' '}
//                       {data?.total_bids === 0
//                         ? ''
//                         : data?.total_bids <= 1
//                         ? 'Bid'
