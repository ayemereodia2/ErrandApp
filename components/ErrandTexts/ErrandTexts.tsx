    ...
    <SafeAreaView className="mb-4">
      <ScrollView>
        <View className="w-[380px] bg-[#f7F0FF] mx-4 mt-6 py-4 px-6">
          ...
          <View className="mt-4">
            <Text className="text-base font-medium">
              I need help repairing my car that’s been faulty over a weekend
              now.It’s been refusing to start for weeks
            </Text>
          </View>
        ...
        <View className="w-[380px] mx-4 mt-6 py-4 px-6">
          <View className="flex-row items-center justify-between">
            <Image
              source={require('../../assets/images/loretta.jpg')}
              className="w-8 h-8 b rounded-full"
            />
        ...
        <View className="w-[380px]mx-4 mt-6 py-4 px-6">
          <View className="flex-row items-center justify-between">
            <Image
              source={require('../../assets/images/multiple.jpg')}
              className="w-8 h-8 b rounded-full"
            />
