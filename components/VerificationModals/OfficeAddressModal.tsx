...
const OfficeAddressModal = ({closeOfficeModal}:any) => {
  ...
  return (
    <View className="py-4 pb-10">
      ...
      <Text className="text-lg text-center font-semibold">Verify your office address</Text>

      <View className="px-4 mt-6">
        <Text className="text-sm text-[#243763] font-semibold">Please verify your current office address</Text>
      ...
      <View className="flex-row justify-around items-center mt-4">
        <TouchableOpacity className="bg-white h-12 w-[40%] mt-6 flex-row justify-center items-center rounded-lg border border-red-600" onPress={closeOfficeModal}>
        ...
        <TouchableOpacity
          className="bg-[#1E3A79] h-12 w-[40%] mt-6 flex-row justify-center items-center rounded-lg" onPress={()=> handleLocation()}>
