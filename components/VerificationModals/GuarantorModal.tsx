...
const GuarantorModal = ({closeGuarantorModal}:any) => {
  ...
  const updateGuarantor = async (GuarantorData: any) => {
  ...
  const handleGuarantor = async () => {
    const updatedData = {
      ...
      guarantor_document: uploadedFiles,
     
    }

    try {
      const responseData = await updateGuarantor(updatedData)
  ...
  return (
    <View className="py-4 pb-10">
      ...
      <Text className="text-lg text-center font-semibold">Guarantor Verification</Text>

      <View className="px-4 mt-6">
        <Text className="text-sm text-[#243763] font-semibold">Please upload the relevant documents.</Text>
      ...
      <View className="flex-row justify-around items-center mt-4">
        <TouchableOpacity className="bg-white h-12 w-[40%] mt-6 flex-row justify-center items-center rounded-lg border border-red-600" onPress={closeGuarantorModal}>
        ...
        <TouchableOpacity
          className="bg-[#1E3A79] h-12 w-[40%] mt-6 flex-row justify-center items-center rounded-lg" onPress={()=> handleGuarantor()}>
