...
export const HaggleComponent = ({
  ...
  function toggleBeginErrandModal(open: boolean) {
    open ? beginErrandRef.current?.present() : beginErrandRef.current?.dismiss()
  }
  ...
  return (
    <View className="py-5 border-b-[0.2px] border-[#ccc] shadow-lg">
              ...
              <View className="w-60">
                ...
                <Text className="text-sm">
                  ...
                  <Text className="text-[12px] text-[#6D6D6D]">
                    {' '}
                    <Entypo name="star" size={12} color="gold" /> (
      ...
      {user_id !== errand.user_id && bid.state == 'cancelled' && (
        <View className="justify-start w-full space-x-3 pt-2 flex ml-14">
          <View className="text-xs border-1 rounded-xl flex space-x-1 justify-center items-center p-2 w-40 bg-red-200 shadow mt-2">
      ...
      {user_id !== errand.user_id && bid.state === 'accepted' && (
        <View className="flex-row ml-1 mt-6 items-center">
          <View className="flex-row gap-2 flex-1 w-3/5">
            <ActionButton
              onPress={() => toggleBeginErrandModal(true)}
              name="run-fast"
              iconColor="#33A532"
              className="w-[30px] h-[30px] border-solid rounded-full border items-center justify-center border-[#33A532]"
            />
          ...
          return (
            ...
            >
              <View className="flex-row ">
                ...
                />
                <View className="w-[340px] h-[150px] ml-2 bg-[#DAE1F1] b rounded-xl px-3">
