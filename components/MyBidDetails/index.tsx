    ...
    <View className="py-5 border-b-[0.2px] border-[#ccc] shadow-lg">
      ...
      {user_id === errand.user_id && bid.state == 'accepted' && (
        <View className="justify-start w-80 space-x-3 mt-2 mx-auto rounded-lg bg-[#c8e2e8] py-2">
          ...
          {/* <div className="text-xs border-1 rounded-xl flex space-x-1 justify-center items-center p-2 w-20 mx-auto bg-[#f2f8f9] shadow mt-2">
      ...
      <BottomSheetModal ref={acceptBidRef} index={0} snapPoints={acceptPoints}>
        <AcceptBid
