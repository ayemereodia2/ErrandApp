...
import {
  Text, Touchable, View, ActivityIndicator, Dimensions, Platform, ScrollView, TouchableOpacity
} from 'react-native'

//  import { Text, Touchable, View } from 'shonacss/components'
     ...
     return (
       ...
       >
         ...
         <View style={{justifyContent: 'center', alignItems: 'center'}}>
          <View design='my-20'>
          <Touchable onPress={() => this.props.navigation.navigate('Register')}>
              <View design='bg-secondary %:p-1.5 px-60 %:m-1.5 %:rounding-0.8 center-center'>
                  <Text design='tc-primary %:ts-4 tw-bold'>Get Started</Text>
              </View>
          </Touchable>
          <View design='flex-row mt-20 justify-center items-center'>
              <TouchableOpacity onPress={() => this.props.navigation.navigate('Login')}>
                  <Text design='tc-secondary tw-bold %:ts-5' style={{textDecorationLine: 'underline'}} >Login</Text>
              </TouchableOpacity>
              <Text design='tc-white tw-bold %:ts-5'> to your account</Text>
          </View>
          </View>
           <Text style={{fontSize:15,color: '#fff'}}>Swipe to explore</Text>
