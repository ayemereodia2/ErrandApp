...
<BottomSheetModalProvider>
   <SafeAreaView className='mt-6'>
    <ScrollView>
        ...
        <TouchableOpacity className='flex-row justify-between items-center mx-4 mt-6' onPress={()=> openPersonalId()}>
            <View className='w-10 h-10 border border-[#3F60AC] items-center justify-center rounded-md'>
                <Text><Ionicons name="md-swap-vertical" size={24} color="#3F60AC" /></Text>
            </View>
            <Text className='font-light leading-8'>Personal Identification</Text>
            <View className='w-[100px] h-[34px] justify-center items-center rounded-[20px]' style={{backgroundColor: data.data.has_verified_personal_id  === 0 || 1 || 2 ? '#FEE1CD' : '#D8F8E9'}}>
        ...
        <TouchableOpacity className='flex-row justify-between items-center mx-4 mt-6' onPress={()=> openEmailModal()}>
            <View className='w-10 h-10 border border-[#3F60AC] items-center justify-center rounded-md'>
            ...
            <View className='w-[100px] h-[34px] justify-center items-center rounded-[20px] ' style={{backgroundColor: data.data.has_verified_email ? '#D8F8E9' : '#FEE1CD'}}>
                <Text className='font-md text-sm' style={{color: data.data.has_verified_email ? '#115A38' : '#642B02'}}>{data.data.has_verified_email ? 'Completed' : 'Incomplete'}</Text>
            </View>
        </TouchableOpacity>


        <TouchableOpacity className='flex-row justify-between items-center mx-4 mt-6' onPress={()=> openOFficeModal()}>
            <View className='w-10 h-10 border border-[#3F60AC] items-center justify-center rounded-md'>
            ...
            <View className='w-[100px] h-[34px] justify-center items-center rounded-[20px]' style={{backgroundColor: data.data.has_verified_location === 0 || 1 || 2 ? '#FEE1CD' : '#D8F8E9'}}>
        ...
        <TouchableOpacity className='flex-row justify-between items-center mx-4 mt-6 mb-40' onPress={()=> openGuarantorModal()}>
            <View className='w-10 h-10 border border-[#3F60AC] items-center justify-center rounded-md'>
                <Text><MaterialIcons name="person-add-alt" size={24} color="#3F60AC" /></Text>
            </View>
            <Text className='font-light leading-8'>Swave Reference Guarantor</Text>
            <View className='w-[100px] h-[34px] justify-center items-center rounded-[20px]' style={{backgroundColor: data.data.has_verified_guarantor === 0 || 1 || 2 ? '#FEE1CD' : '#D8F8E9'}}>
