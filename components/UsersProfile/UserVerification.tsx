    ...
    <SafeAreaView className="mt-10 mb-10">
      ...
      <TouchableOpacity
        ...
        >
          ...
          <Text style={{ color: '#393F42', fontFamily: 'Axiforma' }} className="text-sm ">
            Email Verification
          </Text>
            ...
            <View>
              ...
              (
                ...
                <Text className='text-[#05AE2F] text-sm' style={{fontFamily: 'Axiforma'}}> Completed </Text> 
                </View>
              ) 
              : 
              (
                ...
                <Text className='text-[#E71B1B]'>
                  ...
                  <Text className='text-sm text-[#E71B1B] mt-1' style={{fontFamily: 'Axiforma'}}> Action Required</Text>
                  </View>
              )}
              </View>
           ...
           Personal Identification
            ...
            {data.has_verified_personal_id === 0 ? (
              ...
              <View className='flex-row items-center' style={{gap: 4}}>
                ...
                <Text className='text-[#EF9105] text-sm' style={{fontFamily: 'Axiforma'}}> Pending </Text> 
                </View>
