    ...
    <BottomSheetModalProvider>
      <ScrollView>
        <SafeAreaView>
          <View className="flex-row  ml-[16px] ">
            <TouchableOpacity onPress={handleBoth1}>
              <View className="w-[199px] h-[52px] bg-white  items-center justify-center ">
                <Text className="text-center text-[#243763]">
                  Errand Details
                </Text>
              </View>
            </TouchableOpacity>
            ...
            <View className=" flex-row items-start justify-between pr-2">
              <View className="flex-row items-start gap-3">
                ...
                <View className="flex-1">
                  <Text className="text-[#011E3E] text-base">
                    Kaiya Stanton
                  </Text>
                </View>
            ...
            <View className="flex-row  items-start justify-between ml-16 mt-[-20px] mb-4 ">
              <Text>
                ...
                <Text className="text-[12px] text-[#6D6D6D]">
                  {' '}
                  <Entypo name="star" size={12} color="gold" /> (134 Errands
                  Completed)
                </Text>
              </Text>
              <View className=" mr-2">
          ...
          <View className="ml-4">
            <Text className="leading-[24px] text-[16px] text-[#444444]">
              Lorem ipsum dolor sit amet consectetur. At convallis cu sodales
              lorem et. Consectetur est posuere ferme egess congue lectus purus.
              Mattis libero ultrices at massa he purus.
            </Text>
          </View>
            ...
            <View className="flex-row gap-2 flex-1">
              <TouchableOpacity onPress={handlePresentModal}>
                <View className="w-[40px] h-[40px] border-solid rounded-full border items-center justify-center border-[#33A532]">
                  <Text className="text-[#33A532]  text-center">
                    {' '}
                    <Ionicons name="checkmark" size={24} color="#33A532" />
                  </Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={handleNegotiateBid}>
                <View className="w-[40px] h-[40px] border-solid rounded-full border items-center justify-center border-[#317ACF]">
                  <Text className="text-[#317ACF] text-center">
                    {' '}
                    <FontAwesome name="commenting" size={24} color="#317ACF" />
                  </Text>
                </View>
              </TouchableOpacity>
            </View>
            ...
            <View className="flex-row ">
              ...
              <View className="w-[340px] h-[230px] ml-2 bg-[#DAE1F1] b rounded-xl">
                <View className="flex-row items-center justify-between mt-4">
                  <Text className="pl-3 leading-6 font-semibold text-base">
                    Enoobong George
                  </Text>
                  <Text className="pr-3 leading-6 font-semibold text-sm">
                    2 hours ago
                  </Text>
                </View>
