        ...
        <View className="px-6">
          ...
          <View className="text-[#333333] font-inter mt-10  ">
            ...
            {comingFrom === 'forgotPassword' ? (
              ...
              <Text
                className="mt-[40px]"
                style={{ fontWeight: 'bold', fontSize: 24, color: '#393F42' }}
                onPress={() => Keyboard.dismiss()}
              >
                Verification
              </Text>
            ...
            <Text className="text-[#393F42] text-sm mt-7 font-medium ml-1">
              Code
            </Text>
            ...
            <Text
              className="text-[#09497D] text-sm text-center mb-[50px]"
              style={{ fontFamily: 'Axiforma' }}
            >
              {formatTimer()}
            </Text>
          ...
          {comingFrom === 'forgotPassword' ? (
            <Text
              className="text-[#8E9DA4] text-center mt-3 pb-6 pt-3"
              style={{ fontFamily: 'Axiforma' }}
            >
              Didn’t get code?
              <Text
                ...
                className="font-bold text-[#09497D]"
                style={{ fontFamily: 'Axiforma' }}
              >
                {' '}
                Resend code
            ...
            <View className="flex-row items-center justify-between">
              <Text
                className="text-[#8E9DA4] mt-3 pb-6 pt-3"
                style={{ fontFamily: 'Axiforma' }}
              >
                Didn’t get OTP?
                <Text
              ...
              >
                <Text
                  className="font-bold text-[#09497D] text-sm"
                  style={{ fontFamily: 'Axiforma' }}
                >
                  Change Phone number
                </Text>
