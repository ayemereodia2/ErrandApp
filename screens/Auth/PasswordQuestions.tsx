        ...
        <View className="px-4">
          ...
          > */}
            <View className="text-[#333333] font-inter py-4 space-y-1">
              <Text className="font-semibold text-lg text-center">Password Recovery</Text>
              
              <Text className="text-base text-center">
              Please supply the answer to the security question which you created during your registration
              </Text>

              <View className="pt-4 space-y-4 mt-4">
               

                <Text className='text-[#243763] mt-4 text-center text-base mb-2'>{question ? question : 'No Security Question'}</Text>
