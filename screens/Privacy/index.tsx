...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    <View style={{backgroundColor: backgroundTheme}} className='mx-3 pt-4'>
        ...
        <ScrollView>
      <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}}className='mb-2 text-base leading-6'>
SWAVE manages the information that we collect from you in accordance with applicable international privacy laws for data protection 2021. In this Policy, "SWAVE", "we", "our" and/or "us" means.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'> (i) where you reside in any country Africa or other country you are using the SWAVE platform</Text>
 ...
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'> This Privacy Policy describes how SWAVE collects, uses, shares, and handles your personal data, and sets out the rights and obligations that both you and SWAVE have in relation to your personal data.
...
SWAVE may, from time to time, modify this Privacy Policy (and update the web page on which it is displayed). If we materially change the ways in which SWAVE uses or shares your personal data previously collected from you through the Services, SWAVE will notify you through your SWAVE account, your registered email address or other communication. You should check that account regularly.</Text>
  <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>1. Collection of Your Personal Data
...
SWAVE collects personal data when you pre-register with SWAVE. This includes your full name, email address and location. In circumstances where the below information is not provided to us, we may be unable to provide the Services to you and carry out our contractual obligations with you.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE collects personal data when you register with SWAVE. This includes:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. your name, address, email address, phone number and other contact details.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. your birth date and gender.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. your credit card and account details, which are processed by a third-party service provider that handles payments for us.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. your location and the location where you are interested in performing errands; and</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>v. your occupation, work experience, resume, qualifications, education, post errands, earn money preferences, skillset, interests, and other information relevant for your fitness for errands.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>If you register in certain countries, we also give you the option of providing a photo or video to be associated with your SWAVE user ID. If your personal details change, it is your responsibility to update your SWAVE account with those changes, so that we can keep our records complete, accurate and up to date.
...
Information we collect automatically when you use the Services.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE may also receive and record the following information from your internet browser and computer, including through cookies and similar technologies, when you use the Services:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. Computer and connection information such as statistics on page views, traffic to and from the Services, referral URL, IP address, unique device ID, browsing history and web log information; and</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. Information about your use of the Services, including the date and time you visit the Services, the areas, or pages that you visit, the amount of time you spend viewing or using the Services, the number of times you return to the Services, other clickstream or website usage information, and emails that you open, forward or click-through to the Services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>If you use a location enabled SWAVE service, if you allow us, we receive and process information about your precise location (for example, through GPS signals sent by your mobile device). We may also collect the precise location of your device when the app is running in the foreground or background or when the app is closed. We may also use a range of different technologies to confirm your location. When you use the Services, we also infer the general location of your device and the geographic regions our users come from. For example, your IP address may indicate your general geographic region.
...
We may also receive additional information about you from third parties such as data or marketing partners and combine it with other information we have about you.</Text>
 ...
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Information about you available to others
...
SWAVE does not in any way control and does not accept any responsibility or liability whatsoever for the disclosure or use of personal data which is voluntarily posted by you in a publicly accessible area of the Services.</Text>
 ...
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2. How We Use Your Personal Data</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE may use the information we collect for the following purposes:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. Identification and authentication</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. To protect SWAVE and the users of the Services</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. To customize the content and any advertising displayed on the Services and permit content on the Services (such as postings, marketing or third-party advertisements) to be targeted, on an aggregate basis, to the users for whom it is most likely to be relevant.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. To improve the Services and develop new service features.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>v. To provide, maintain and protect the Services and to verify the identity of authorized users of the Services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>vi. Providing your information to a user with whom you have or had a contract facilitated by SWAVE.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>vii. As required by law, order of a court, tribunal, or regulator or if SWAVE reasonably believes that the use or disclosure of the information is reasonably necessary for enforcement related activities.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>viii. To ensure that SWAVE receives payment of the fees due to it.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ix. To contact you to inform you about promotions or upcoming changes or improvements to the Services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>We take this information as specified for the following legal reasons:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. We need to perform this function to allow you to access the Services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. it is in our (and users) legitimate interests to ensure that the Services are secure.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. It is in our legal interest to provide you with content and advertisements that are tailored to your interests.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. We need some of your personal data to provide the services to you; it is in our legitimate interests to provide you with the best possible services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>v. We need to perform this function to provide a safe and secure environment for our users and we have legitimate interests in protecting the integrity of the Services we offer.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>vi. We need to use your personal data in this way to provide the Services you request.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>vii. On such occasions, we are required by law to process your personal data.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>viii. We need to use your personal data in this way to fulfil a contract between you and us.</Text>

 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>We only contact you for marketing purposes with your consent; we may contact you regarding changes in the Services because it is in our legitimate interests to keep you informed about service changes that may affect you. See section below for further detail about marketing.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>To contact you to administer our User Agreement
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Legal ground(s) for use: It is in our legitimate interests to improve the Services through user questionnaires and feedback requests via the Services.
To expand our user base, including marketing communications to be targeted to potential users.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Legal ground(s) for use: It is in our legitimate interest to inform potential users about the Services we offer.
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. To generate data reports on an aggregated, non-personally identifiable basis, for both internal and third party use, but subject to any applicable laws (for example, we may show advertisers or investors trends relating to the general use of the Services); and
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. Your contact information may also be used for accounting, invoicing, and billing purposes, marketing purposes, by third party service providers to SWAVE, and to respond to any enquiry you make.
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. When you contact SWAVE, we may keep a record of the communication(s) between you and SWAVE to help resolve any issues you might have.
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. If other user(s) of the Services already have your user ID (or other information identifying you), and you have chosen to upload a photo or other personal data to your SWAVE account, we may show those user(s) that personal data.
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>The Services allow you to review your experience dealing with others on the Services, who may in turn leave reviews about you. We compile these reviews to provide an aggregate rating for each user, which will publicly appear along with your profile. Please be aware that other users may rely on this rating when deciding whether to engage with you.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Profiling and data analytics
...
We do not use sensitive information for data analytics.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3. Cookies and Similar Technologies</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE uses cookies and similar tracking technologies for several purposes including to access your information when you sign in, keep track of your preferences, direct specific content to you, report on SWAVE's user base, and to improve SWAVE's services. We also use cookies or anonymous identifiers when you interact with our affiliate service providers (for example, when you integrate your SWAVE account with your Facebook profile) and as further described below.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>We use the following types of cookies and similar technologies:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Strictly Necessary Cookies</Text>
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3. Performance Analytics Cookies
...
If you wish to prevent your data from being used by Google Analytics, Google has developed the Google Analytics opt-out browser add-on available here, and you can manage your Google accounts here.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4. How We Share Your Personal Data
...
With Your Permission. We may share your personal data with any other third party with your consent or as necessary to deliver a service you requested.</Text>
 <Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>5. Security
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>6. Third Parties
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>7. International Transfers
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>8. Marketing
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>9. Your Rights and Choices you can make
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>10. Retention
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>11. Children’s Privacy
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>12. Contact us
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE Data Retention Policy</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>1. Introduction
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2. Data Categories
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3. Purpose of Data Retention
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. Fulfilling service requests, including matching users with service providers.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. Complying with legal obligations, such as tax and financial regulations.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. Resolving disputes and conflicts, including transaction-related issues.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. Investigating and preventing fraud, security breaches, and misconduct.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>v. Ensuring historical records for transparency, user support, and improvement of our platform.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4. Data Retention Periods</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>SWAVE establishes specific data retention periods based on the type and purpose of the data. Below are general guidelines for data retention:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4.1. Personal Information:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4.2. Sensitive User Data:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4.3. Communication Records:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>4.4. Location Data:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>5. Data Deletion Procedures
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>i. Identification of data eligible for deletion based on the retention policy.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>ii. Secure deletion from all active databases and systems.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iii. Removal from backups during regular data backup cycles.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>iv. Verification of successful data deletion.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>6. User Control
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>7. Compliance with Regulations
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>8. Contact Information
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >2. Data Categories
SWAVE collects and processes various categories of data, including personal information and sensitive user data. The data may encompass but is not limited to user profiles, transaction history, communication records, location data, and identification documents.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3. Purpose of Data Disclosure
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3.1. Service Delivery:
To connect users with service providers and facilitate requested services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.2. Legal Compliance: className='mb-2 text-base leading-6' className='mb-2 text-base leading-6'
To comply with legal and regulatory requirements, including tax, financial, and reporting obligations.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.3. Dispute Resolution:
To investigate and resolve disputes or conflicts between users.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.4. Fraud Prevention and Security:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >To prevent and address fraud, security breaches, and misconduct on our platform.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.5. Platform Improvement:
To analyze user interactions and behavior to improve our platform and services.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4. Types of Data Disclosure</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4.1. Disclosure to Service Providers:
User data may be shared with service providers who are directly involved in providing services to users.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4.2. Disclosure to Users:
Certain user data, such as profiles and reviews, is visible to other users on the platform.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4.3. Disclosure to Third-Party Partners:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'  >4.4. Legal Disclosure:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' > 5. Data Anonymization
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >6. Consent for Data Disclosure
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >7. Data Security
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>8. Compliance with Regulations
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>9. Contact Information
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Secure Data Handling Policy for SWAVE</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>1. Introduction
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2. Data Classification
Data at SWAVE is classified into the following categories:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2.1. Personal Data:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2.2. Sensitive User Data:
Highly confidential data, such as identification numbers, is treated with special care and access restrictions.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2.3. Communication Records:
Records of communications between users and between users and SWAVE, including messages and chat logs.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>2.4. Location Data:
Data related to user location, collected to facilitate service requests.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3. Data Handling Procedures</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3.1. Data Access and Usage:</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>Data access is granted on a need-to-know basis. Employees and contractors are only provided access to data required for their job responsibilities.
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3.2. Data Transmission:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>3.3. Password Protection:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.4. Data Storage:
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.5. Data Encryption:
Data in transit and at rest should be encrypted to protect it from unauthorized access.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.6. Training:
Employees and contractors should receive regular training in data handling best practices and security procedures.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4. Data Breach Response
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >Data Deletion Policy for SWAVE</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >1. Introduction
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3. Data Deletion Procedures</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.1. Data Identification:
Data eligible for deletion is identified based on the data retention policy.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.2. Secure Deletion:
Data is securely deleted from all active databases, systems, and locations where it is stored.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.3. Removal from Backups:
Data is removed from backups during regular data backup cycles.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >3.4. Verification:
Successful data deletion is verified to ensure data is irreversibly removed.</Text>
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6' >4. Legal and Regulatory Compliance
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>5. User Control
...
<Text style={{color: textTheme, fontFamily: 'Axiforma', fontSize: 14}} className='mb-2 text-base leading-6'>6. Contact Information
