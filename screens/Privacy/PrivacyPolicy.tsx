...
const PrivacyPolicy = () => {
  ...
  return (
    <SafeAreaView style={{backgroundColor: backgroundTheme}} className='px-4 pt-4'>
...
SWAVE manages the information that we collect from you in accordance with applicable international privacy laws for data protection 2021. In this Policy, "SWAVE", "we", "our" and/or "us" means.
(i) where you reside in any country Africa or other country you are using the SWAVE platform
(ii) where you reside anywhere outside the African region Exemplar Projects Group Pty Limited, an Australian company.
This Privacy Policy describes how SWAVE collects, uses, shares, and handles your personal data, and sets out the rights and obligations that both you and SWAVE have in relation to your personal data.
...
SWAVE collects personal data when you pre-register with SWAVE. This includes your full name, email address and location. In circumstances where the below information is not provided to us, we may be unable to provide the Services to you and carry out our contractual obligations with you.
SWAVE collects personal data when you register with SWAVE. This includes:
i. your name, address, email address, phone number and other contact details.
ii. your birth date and gender.
iii. your credit card and account details, which are processed by a third-party service provider that handles payments for us.
iv. your location and the location where you are interested in performing errands; and
v. your occupation, work experience, resume, qualifications, education, post errands, earn money preferences, skillset, interests, and other information relevant for your fitness for errands.
If you register in certain countries, we also give you the option of providing a photo or video to be associated with your SWAVE user ID. If your personal details change, it is your responsibility to update your SWAVE account with those changes, so that we can keep our records complete, accurate and up to date.
...
SWAVE may also receive and record the following information from your internet browser and computer, including through cookies and similar technologies, when you use the Services:
i. Computer and connection information such as statistics on page views, traffic to and from the Services, referral URL, IP address, unique device ID, browsing history and web log information; and
ii. Information about your use of the Services, including the date and time you visit the Services, the areas, or pages that you visit, the amount of time you spend viewing or using the Services, the number of times you return to the Services, other clickstream or website usage information, and emails that you open, forward or click-through to the Services.
...
Information about you available to others
...
SWAVE does not in any way control and does not accept any responsibility or liability whatsoever for the disclosure or use of personal data which is voluntarily posted by you in a publicly accessible area of the Services.

2. How We Use Your Personal Data
SWAVE may use the information we collect for the following purposes:
i. Identification and authentication
ii. To protect SWAVE and the users of the Services
iii. To customize the content and any advertising displayed on the Services and permit content on the Services (such as postings, marketing or third-party advertisements) to be targeted, on an aggregate basis, to the users for whom it is most likely to be relevant.
iv. To improve the Services and develop new service features.
v. To provide, maintain and protect the Services and to verify the identity of authorized users of the Services.
vi. Providing your information to a user with whom you have or had a contract facilitated by SWAVE.
vii. As required by law, order of a court, tribunal, or regulator or if SWAVE reasonably believes that the use or disclosure of the information is reasonably necessary for enforcement related activities.
viii. To ensure that SWAVE receives payment of the fees due to it.
ix. To contact you to inform you about promotions or upcoming changes or improvements to the Services.
We take this information as specified for the following legal reasons:
i. We need to perform this function to allow you to access the Services.
ii. it is in our (and users) legitimate interests to ensure that the Services are secure.
iii. It is in our legal interest to provide you with content and advertisements that are tailored to your interests.
iv. We need some of your personal data to provide the services to you; it is in our legitimate interests to provide you with the best possible services.
v. We need to perform this function to provide a safe and secure environment for our users and we have legitimate interests in protecting the integrity of the Services we offer.
vi. We need to use your personal data in this way to provide the Services you request.
vii. On such occasions, we are required by law to process your personal data.
viii. We need to use your personal data in this way to fulfil a contract between you and us.

We only contact you for marketing purposes with your consent; we may contact you regarding changes in the Services because it is in our legitimate interests to keep you informed about service changes that may affect you. See section below for further detail about marketing.
...
i. To generate data reports on an aggregated, non-personally identifiable basis, for both internal and third party use, but subject to any applicable laws (for example, we may show advertisers or investors trends relating to the general use of the Services); and
Legal reason(s) for use: It is in our legitimate interests (and the interests of our partners and affiliates) to understand how you and other users engage with the Services.
ii. Your contact information may also be used for accounting, invoicing, and billing purposes, marketing purposes, by third party service providers to SWAVE, and to respond to any enquiry you make.
Legal reason(s) for use: It is in our legitimate interests to engage service providers to assist us in delivering the Services you request.
iii. When you contact SWAVE, we may keep a record of the communication(s) between you and SWAVE to help resolve any issues you might have.
Legal reason(s) for use: We retain information when we are required to do so by law and because it is in our legitimate interests to protect our legal rights.
iv. If other user(s) of the Services already have your user ID (or other information identifying you), and you have chosen to upload a photo or other personal data to your SWAVE account, we may show those user(s) that personal data.
Legal reason(s) for use: We display your photo to other users who have your user ID only with your consent, which you supply by uploading your photo.
...
SWAVE uses cookies and similar tracking technologies for several purposes including to access your information when you sign in, keep track of your preferences, direct specific content to you, report on SWAVE's user base, and to improve SWAVE's services. We also use cookies or anonymous identifiers when you interact with our affiliate service providers (for example, when you integrate your SWAVE account with your Facebook profile) and as further described below.
...
If you change the settings on your internet browser to block or restrict cookies (including cookies associated with the Services), or to indicate when a cookie is being set by SWAVE, the Services may not work as intended. You should remember that, while you may still be able to use the Services if your cookies are disabled, the Services may not function properly on your device, and you may not be able to take advantage of certain SWAVE features.
...
SWAVE reserves the right to send you administrative and account-related messages even if you opt out of receiving Marketing Material.
9. Your Rights and Choices you can make
...
10. Retention
We retain your personal data for as long as is necessary regarding the purposes for which it was collected or lawfully further processed, or for as long as may be necessary considering our legal obligations or to allow us to pursue, defend or exercise legal claims.
...
12. Contact us
If you have any questions about this Privacy Policy or about the way we process your personal data, please contact us: support@swaveafrica.com contactline@exemplarproject.org

SWAVE Data Retention Policy
1. Introduction
This Data Retention Policy outlines the principles and procedures governing the retention and deletion of user data collected by SWAVE. SWAVE is committed to ensuring that user data is handled in a secure and responsible manner, and that data retention is carried out in compliance with applicable laws and regulations.
2. Data Categories
SWAVE collects and processes various categories of data, including personal information and sensitive user data. The data may encompass but is not limited to user profiles, transaction history, communication records, location data, and identification documents.
3. Purpose of Data Retention
The primary purpose of retaining user data is to facilitate the delivery of services and ensure legal compliance. Data retention is necessary for:
i. Fulfilling service requests, including matching users with service providers.
ii. Complying with legal obligations, such as tax and financial regulations.
iii. Resolving disputes and conflicts, including transaction-related issues.
iv. Investigating and preventing fraud, security breaches, and misconduct.
v. Ensuring historical records for transparency, user support, and improvement of our platform.
4. Data Retention Periods
SWAVE establishes specific data retention periods based on the type and purpose of the data. Below are general guidelines for data retention:
...
Data related to past transactions is generally retained for a period of [six months] from the date of the transaction.
4.2. Sensitive User Data:
...
Deletion of sensitive user data is carried out promptly upon the completion of legal obligations.
...
After the specified retention period, communication records are securely deleted.
4.4. Location Data:
Location data is retained for as long as the user's location services are enabled within the app.
Users have the option to disable location services at any time, after which no new location data is collected.
5. Data Deletion Procedures
SWAVE has implemented data deletion procedures to ensure secure and irreversible removal of user data. When data reaches the end of its retention period, it is promptly deleted from all active databases, archives, and backups. SWAVE takes the following steps to delete data:
i. Identification of data eligible for deletion based on the retention policy.
ii. Secure deletion from all active databases and systems.
iii. Removal from backups during regular data backup cycles.
iv. Verification of successful data deletion.
6. User Control
Users have control over some aspects of their data retention. This includes the ability to update or delete their account information. Users may also revoke consent for certain data processing activities, as outlined in our Privacy Policy.
7. Compliance with Regulations
SWAVE is committed to adhering to data protection laws and regulations that may require specific data retention periods or procedures. We continuously review and update our data retention practices, remaining compliant with evolving legal requirements.
...
SWAVE Data Disclosure Policy
1. Introduction
This Data Disclosure Policy outlines SWAVE's approach to the disclosure of user data and the circumstances under which user data may be shared with third parties. We are committed to ensuring the privacy and security of user data and to being transparent about our data sharing practices.
2. Data Categories
SWAVE collects and processes various categories of data, including personal information and sensitive user data. The data may encompass but is not limited to user profiles, transaction history, communication records, location data, and identification documents.
3. Purpose of Data Disclosure
User data may be disclosed for specific purposes in line with our commitment to providing services, legal compliance, and the improvement of our platform. Data disclosure may be necessary for:
3.1. Service Delivery:
To connect users with service providers and facilitate requested services.
3.2. Legal Compliance:
To comply with legal and regulatory requirements, including tax, financial, and reporting obligations.
3.3. Dispute Resolution:
To investigate and resolve disputes or conflicts between users.
3.4. Fraud Prevention and Security:
To prevent and address fraud, security breaches, and misconduct on our platform.
3.5. Platform Improvement:
To analyze user interactions and behavior to improve our platform and services.
4. Types of Data Disclosure
4.1. Disclosure to Service Providers:
User data may be shared with service providers who are directly involved in providing services to users.
4.2. Disclosure to Users:
Certain user data, such as profiles and reviews, is visible to other users on the platform.
4.3. Disclosure to Third-Party Partners:
Data may be shared with trusted third-party partners for purposes such as marketing, analytics, or improving user experience.
4.4. Legal Disclosure:
Data may be disclosed to comply with legal obligations, respond to law enforcement or government requests, or protect the rights and safety of our users and SWAVE.
5. Data Anonymization
To protect user privacy, SWAVE may use data anonymization techniques to ensure that disclosed data cannot be traced back to individual users.
6. Consent for Data Disclosure
SWAVE may obtain user consent for certain data processing and disclosure activities, as outlined in our privacy policy.
7. Data Security
We take data security seriously and have implemented measures to protect user data against unauthorized access, disclosure, or alteration.
8. Compliance with Regulations
SWAVE is committed to adhering to data protection laws and regulations related to data disclosure. We continuously review and update our data disclosure practices, remaining compliant with evolving legal requirements.
9. Contact Information
If you have questions or concerns about our Data Disclosure Policy or the disclosure of specific data, please contact us at support@swaveafrica.com contactline@exemplarproject.org

Secure Data Handling Policy for SWAVE
1. Introduction
This Secure Data Handling Policy outlines SWAVE's commitment to ensuring the security, confidentiality, and integrity of user data. Secure data handling is fundamental to maintaining user trust and complying with data protection regulations.
2. Data Classification
Data at SWAVE is classified into the following categories:
2.1. Personal Data:
Information that can be used to identify an individual, including user profiles, contact information, and transaction history.
2.2. Sensitive User Data:
Highly confidential data, such as identification numbers, is treated with special care and access restrictions.
2.3. Communication Records:
Records of communications between users and between users and SWAVE, including messages and chat logs.
2.4. Location Data:
Data related to user location, collected to facilitate service requests.
3. Data Handling Procedures
3.1. Data Access and Usage:
Data access is granted on a need-to-know basis. Employees and contractors are only provided access to data required for their job responsibilities.
Data should not be shared or used for personal purposes, and employees must adhere to a strict code of confidentiality.
3.2. Data Transmission:
Data transmitted over internal and external networks should be encrypted to protect it from interception or unauthorized access.
3.3. Password Protection:
Passwords should be complex, unique, and changed regularly.
Passwords must not be shared or written down in an accessible location.
3.4. Data Storage:
Data should be stored securely, with access restricted to authorized personnel.
Hard copies of data should be stored securely and disposed of through secure shredding.
3.5. Data Encryption:
Data in transit and at rest should be encrypted to protect it from unauthorized access.
3.6. Training:
Employees and contractors should receive regular training in data handling best practices and security procedures.
4. Data Breach Response
In the event of a data breach, SWAVE will follow a pre-established response plan that includes notifying affected parties, investigating the breach, and taking corrective action to prevent similar incidents in the future. Data breach response procedures comply with applicable data protection laws and regulations.

Data Deletion Policy for SWAVE
1. Introduction
This Data Deletion Policy outlines SWAVE's procedures for the secure and irreversible deletion of user data. Data deletion is essential to comply with data protection regulations and to ensure that user data is not retained beyond the necessary period.
2. Data Categories
User data collected by SWAVE falls into the following categories:
2.1. Personal Data:
Information that can be used to identify an individual, such as user profiles, contact information, and transaction history.
2.2. Sensitive User Data:
Highly confidential data, including identification numbers.
2.3. Communication Records:
Records of communications between users and SWAVE, including messages and chat logs.
3. Data Deletion Procedures
3.1. Data Identification:
Data eligible for deletion is identified based on the data retention policy.
3.2. Secure Deletion:
Data is securely deleted from all active databases, systems, and locations where it is stored.
3.3. Removal from Backups:
Data is removed from backups during regular data backup cycles.
3.4. Verification:
Successful data deletion is verified to ensure data is irreversibly removed.
4. Legal and Regulatory Compliance
SWAVE complies with data protection regulations that may require specific data deletion periods or procedures. We continuously review and update our data deletion practices remaining compliant with evolving legal requirements.
5. User Control
Users can update or delete their account information through the SWAVE app. They may also revoke consent for certain data processing activities, as outlined in our Privacy Policy.
