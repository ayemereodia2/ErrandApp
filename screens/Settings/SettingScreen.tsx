...
<   View className='bg-purple-200 h-[160px] w-screen shadow-md' style={{borderBottomLeftRadius: 70, borderBottomRightRadius: 70}}>
   <View className='bg-[#09497D] h-[150px] pt-[70px] px-6 pb-3 pl-[27px]' style={{borderBottomLeftRadius: 70, borderBottomRightRadius: 70}}>
      ...
      <Ionicons name="chevron-back-outline" size={24} color="white" />
         ...
         <Text className='text-white text-xl font-medium' style={{fontFamily: 'Chillax'}}>Settings</Text>
...
{/* 
            ...
            <View className=" mt-6 px-4">
              ...
              <View className='flex-row items-center py-3 pl-2 pr-2 mx-2 bg-[#fefefe] rounded-[10px]'>
                <TouchableOpacity className='bg-[#f3f3f3] flex-row items-center py-2 pl-3 pr-4 rounded-[10px]' style={{gap: 14}} onPress={() => copyToClipboard(data?.data?.referral_code)}>
                  <Text className='text-sm text-[#09497D]' style={{fontFamily: 'Axiforma'}}>{data?.data?.referral_code}</Text>
                  <Text className='text-[#888686] text-xs' style={{fontFamily: 'Axiforma'}}>Tap to copy code</Text>
                </TouchableOpacity>
              ...
              >
                <TouchableOpacity className='flex-row items-center justify-between mt-4'>
                  ...
                  <Text className='text-base text-[#444444] mr-3' style={{fontFamily: 'Axiforma'}}> 
                  <MaterialCommunityIcons name="flag-outline" size={20} color="black" /> 
                  </Text>
                  <Text className='text-base text-[#444444]' style={{fontFamily: 'Axiforma'}}>Report a problem</Text>
                ...
                <TouchableOpacity className=" h-[63px]  mt-4" onPress={() => setDeleteModal(true)}>
                  ...
                  <Text className='text-base text-[#444444] ml-3' style={{fontFamily: 'Axiforma'}}>
                      Delete My Account
                    </Text>
                    </View>
                ...
                >
                  ...
                  <Text className='text-base text-[#444444]' style={{fontFamily: 'Axiforma'}}>Log out</Text>
