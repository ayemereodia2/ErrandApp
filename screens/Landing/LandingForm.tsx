  ...
  return (
    ...
    <SafeAreaView className='mx-4 mt-10 '>
      ...
      <View className="px-4 mt-5">
        <Text className="text-sm font-semibold text-[#243763]">Description</Text>

        <View className="w-full border bg-[#F5F5F5] border-[#E6E6E6] text-sm py-2 mt-2 rounded-lg px-3">
          <TextInput
            className={
              'w-full text-sm py-2 mt-2 rounded-lg px-3'
            }
    ...
    <View className="w-full border bg-[#F5F5F5] border-[#E6E6E6] text-sm py-1 mt-2 rounded-lg px-3 mx-3" style={{display: clicked ? 'flex' : 'none'}}>
          <TextInput
            className={
              'w-full text-sm py-2 mt-2 rounded-lg px-3'
            }
        ...
        <TouchableOpacity className="bg-white h-8 w-[20%] mt-2 flex-row justify-center items-center rounded-lg border border-red-600 mx-4" style={{display: clicked ? 'flex' : 'none'}}  onPress={handleClose}>
      ...
      <TouchableOpacity
          className="bg-[#1E3A79] h-16 w-[100%] mt-6 flex-row justify-center items-center rounded-lg ">
