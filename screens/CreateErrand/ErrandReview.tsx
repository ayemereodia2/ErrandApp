...
const ErrandReview = ({navigation}:any) => {
  return (
    ...
    <Text className='font-semibold text-[#243763] text-base'>Errand Review</Text>
  </View>
  ...
  <Text className='text-[#243763] font-semibold text-[20px]'>Errand Category</Text>
  </View>
  ...
  <View className='ml-4 mt-6'>
    ...
    <Text className='font-medium text-base text-[#333333]'>Baby Sitting</Text>
  </View>

  <View className='w-[390px] b border-b-[3px] ml-4 mt-[56px] border-[#EEEEEE]'>
  <Text className='text-[#243763] font-semibold text-[20px]'>Errand Details</Text>
  </View>

  <View className='ml-4 mt-6'>
    <Text className='font-bold text-[14px]'>Description</Text>
    <Text className='font-medium text-base text-[#333333]'>I want someone who is good with watching over babies within the age of 0-3 years old  while i go out for a conference meeting.</Text>
  </View>
  ...
  <View className='mt-4 ml-4'>
   ...
   <View className='flex-row mt-3 w-[378px] h-[70px] mx-auto bg-[#011E3E] items-center justify-center b rounded-lg'>
    ...
    <Text><AntDesign name="delete" size={24} color="white" /></Text>
   </View>

    <View className='ml-4 mt-10'>
        <Text className='text-[#314B87] font-normal text-base'>Restrict Errand by Qualification</Text>
        <Text>Yes</Text>
    </View>

    <View className='ml-4 mt-10'>
        <Text className='text-[#314B87] font-normal text-base'>Restrict Errand by Verification</Text>
        <Text>Yes</Text>
    </View>

    <View className='ml-4 mt-10'>
        <Text className='text-[#314B87] font-normal text-base'>Restrict Errand by Insurance</Text>
        <Text>No</Text>
    </View>
