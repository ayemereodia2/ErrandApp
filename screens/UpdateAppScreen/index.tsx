...
import { SafeAreaView, BackHandler, Text, Touchable, View } from 'react-native'
    ...
    >
      <View className="px-6 w-full">
        <View className="bg-white h-72 rounded-xl">
          ...
          <Text className='text-center px-6 pt-4 text-sm text-[#838181]'>Please click to update your app on the store </Text>
